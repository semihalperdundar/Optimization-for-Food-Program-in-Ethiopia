# -*- coding: utf-8 -*-
"""Çabalıyorum Senaryo III Uptated.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1SxfFoauv7NJVKqjTEMEQNxkVRcC35qv9
"""
...
def build_and_solve_model(beneficiaries_dict_local, port_capacity_dict_local, warehouse_cap_dict_local,
    ...
    for f, com in enumerate(commodities_proc):
        if com in commodity_list_nutr:
            ...
            print("Warning: {} not found in nutrient values, assigning zero.".format(com))
    ...
    print("\n=== Solving Scenario: {} ===".format(scenario_name))
    # Ek: CVXPY Baslik Ciktisi
    print("===============================================")
    print("                 CVXPY")
    print("                 v1.6.2")
    print("===============================================")

    # Cozum asamasi: verbose=True ile solver loglarinin tamamini gormek mumkun
    result_lp = lp_problem.solve(solver=cp.GLPK_MI, verbose=True)

    # Ek: Cozum Ozeti Ciktisi
    print("\n-----------------------------------------------")
    print("Solver Cikti Ozeti")
    print("Problem Durumu: {}".format(lp_problem.status))
    print("Optimal Deger (penaltiler dahil): {}".format(result_lp))
    print("-----------------------------------------------\n")
